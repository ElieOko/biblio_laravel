                    ...
                    <div class="w-full lg:w-1/2 mt-6 pl-0 lg:pl-2">
                        ...
                        <div class="leading-loose">
                            ...
                            <form class="p-10 bg-white rounded shadow-xl" action="" method="post">
                                ...
                                <div class=" mt-2">
                                    <label class="block text-sm text-gray-600" for="Directeur">Section</label>
                                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="" name="section" type="text" required="" placeholder="Matricule" aria-label="Directeur">
                                </div>
                                <div class=" mt-2">
                                    <label class="block text-sm text-gray-600" for="cus_name">Promotion</label>
                                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="cus_n" name="promotion" type="text" required="" placeholder="Grade " aria-label="Name">
                                </div>
                                <div class="mt-6">
