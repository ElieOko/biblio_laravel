...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <a href="AjoutProf.html" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            <i class="fas fa-user-alt mr-3"></i>
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-3xl text-black pb-6">G1</h1>

                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> Liste
                    </p>
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Prenom</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Section</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Promotion</td>
                                </tr>
                            </thead>
                            <tbody class="text-gray-700">
                                @forelse ($etudiants as $item)
                                    <tr>
                                        ...
                                        <td class="text-left py-3 px-4">{{ $item->promotion }}</td>
                                    </tr>
                                    @empty
                                    <tr>
                                        <td colspan="5">
